...
interface SubmitWorkToCollectionButtonProps {
    collectionId: string;
    existingWorkIds: string[];
    className?: string;
}

export default function SubmitWorkToCollectionButton({ collectionId, existingWorkIds, className }: SubmitWorkToCollectionButtonProps) {
    ...
    return (
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetFormContent
                ...
                description="Wählen Sie ein Werk aus, das Sie zu dieser Sammlung hinzufügen möchten."
                footer={
                    <>
