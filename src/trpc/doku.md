Copied from (the official Docs)[https://trpc.io/docs/client/tanstack-react-query/server-components]
...
```typescript app/client-greeting.tsx
'use client';
